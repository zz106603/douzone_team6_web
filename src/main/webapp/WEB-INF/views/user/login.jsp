					...
					<div class="card-body">
						<form>
							<div class="input-group form-group">
								<input type="text" class="form-control" placeholder="이메일 아이디">
							</div>
							...
							<!-- 계정을 기억할지 말지에 대한 체크박스 email_password.js 파일 내의 remember_check()를 통해 완성 예정-->
							<div class="row form-group align-items-center" id="remember">
								<div>
									<input type="checkbox" id="id-remember"> 이 계정을 기억합니다.
								</div>
							</div>
